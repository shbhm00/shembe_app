            ...
            <View style={[styles.container,this.state.modalVisible ? {backgroundColor: 'rgba(0,0,0,0.5)'} : '']}>
                ...
                <View style={styles.subcontainer}>
                    ...
                    <Gradient
                        ...
                        mtp={5}
                    />
                    <Text style={styles.para}>Don’t worry just enter the email address or
mobile number associated with your account.</Text>
                    <Formik
                    initialValues={{email:''}}
                    ...
                    onPress={()=>props.touched.email && props.errors.email===undefined?this.setState({modalVisible:!this.state.modalVisible}):props.handleSubmit()}
                    />
                    </View>
                    </View>
                    )}
                ...
                >
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            ...
                            <Text style={styles.para1}>A verification code has been sent to your registered email address and mobile..</Text>
                            <Pressable
                                style={styles.buttonClose}
                                onPress={() => {this.setState({modalVisible:!this.state.modalVisible});(this.props.navigation.navigate('Otp'))}}
                            >
